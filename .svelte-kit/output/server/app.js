...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-711e04d4.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-711e04d4.js", assets + "/_app/chunks/vendor-5d68c66f.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-daef9be3.js", "css": [], "js": ["layout.svelte-daef9be3.js", "chunks/vendor-5d68c66f.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-c2a0b112.js", "css": [], "js": ["error.svelte-c2a0b112.js", "chunks/vendor-5d68c66f.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-6a07ec24.js", "css": ["assets/pages/index.svelte-8ea154ae.css"], "js": ["pages/index.svelte-6a07ec24.js", "chunks/vendor-5d68c66f.js"], "styles": [] } };
...
var Steps_svelte_svelte_type_style_lang = ".steps-container.svelte-jq8oz2.svelte-jq8oz2{font-family:var(--font-family)}.block.svelte-jq8oz2.svelte-jq8oz2{display:flex;flex-flow:row nowrap}.block.svelte-jq8oz2 .background.svelte-jq8oz2,.block.svelte-jq8oz2 .foreground.svelte-jq8oz2{box-sizing:border-box;width:100%;flex:none}.block.svelte-jq8oz2 .foreground.svelte-jq8oz2{margin-left:-100%}.step.svelte-jq8oz2.svelte-jq8oz2{border-radius:var(--border-radius);display:flex;align-items:center;justify-content:center;width:var(--size);height:var(--size);font-size:calc(var(--size) * 0.5)}.step.svelte-jq8oz2.svelte-jq8oz2:hover{cursor:pointer;filter:brightness(85%)}.d-flex.svelte-jq8oz2.svelte-jq8oz2{display:flex}.d-flex.align-items-start.svelte-jq8oz2.svelte-jq8oz2{align-items:flex-start}.d-flex.align-items-center.svelte-jq8oz2.svelte-jq8oz2{align-items:center}.d-flex.justify-content-center.svelte-jq8oz2.svelte-jq8oz2{justify-content:center}.d-flex.justify-content-space-around.svelte-jq8oz2.svelte-jq8oz2{justify-content:space-around}.text-primary.svelte-jq8oz2.svelte-jq8oz2{color:var(--primary) !important}.text-light.svelte-jq8oz2.svelte-jq8oz2{color:var(--light) !important}.text-dark.svelte-jq8oz2.svelte-jq8oz2{color:var(--dark) !important}.bg-secondary.svelte-jq8oz2.svelte-jq8oz2{background-color:var(--secondary) !important}.bg-primary.svelte-jq8oz2.svelte-jq8oz2{background-color:var(--primary) !important}.shadow.svelte-jq8oz2.svelte-jq8oz2{box-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15) !important}";
const css$1 = {
  code: ".steps-container.svelte-jq8oz2.svelte-jq8oz2{font-family:var(--font-family)}.block.svelte-jq8oz2.svelte-jq8oz2{display:flex;flex-flow:row nowrap}.block.svelte-jq8oz2 .background.svelte-jq8oz2,.block.svelte-jq8oz2 .foreground.svelte-jq8oz2{box-sizing:border-box;width:100%;flex:none}.block.svelte-jq8oz2 .foreground.svelte-jq8oz2{margin-left:-100%}.step.svelte-jq8oz2.svelte-jq8oz2{border-radius:var(--border-radius);display:flex;align-items:center;justify-content:center;width:var(--size);height:var(--size);font-size:calc(var(--size) * 0.5)}.step.svelte-jq8oz2.svelte-jq8oz2:hover{cursor:pointer;filter:brightness(85%)}.d-flex.svelte-jq8oz2.svelte-jq8oz2{display:flex}.d-flex.align-items-start.svelte-jq8oz2.svelte-jq8oz2{align-items:flex-start}.d-flex.align-items-center.svelte-jq8oz2.svelte-jq8oz2{align-items:center}.d-flex.justify-content-center.svelte-jq8oz2.svelte-jq8oz2{justify-content:center}.d-flex.justify-content-space-around.svelte-jq8oz2.svelte-jq8oz2{justify-content:space-around}.text-primary.svelte-jq8oz2.svelte-jq8oz2{color:var(--primary) !important}.text-light.svelte-jq8oz2.svelte-jq8oz2{color:var(--light) !important}.text-dark.svelte-jq8oz2.svelte-jq8oz2{color:var(--dark) !important}.bg-secondary.svelte-jq8oz2.svelte-jq8oz2{background-color:var(--secondary) !important}.bg-primary.svelte-jq8oz2.svelte-jq8oz2{background-color:var(--primary) !important}.shadow.svelte-jq8oz2.svelte-jq8oz2{box-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15) !important}",
  map: '{"version":3,"file":"Steps.svelte","sources":["Steps.svelte"],"sourcesContent":["<!--\\n    @component \\n\\n    @name svelte-steps\\n\\n    @description This is the steps component.\\n\\n    @props \\n    \\n    - `steps`:\\n\\t- Array of object. Length has to be more than 1\\n\\t- Required\\n\\t- Each item is a step object that can have:\\n\\t\\t- `text`: The text displayed below each steps.\\n\\t\\t- `icon`: A svelte component displayed inside each steps.\\n\\t\\t- `iconProps`: An object that will be passed as props to the `icon` component.\\n\\t- `current`: current step index. Number. Default `0`\\n\\t- `size`: size of the step buttons. String. Default `\\"3rem\\"`\\n\\t- `lineHeight`: height of the connecting lines between the step buttons. String. Default `\\"0.3rem\\"`\\n\\t- `primary`: Primary color of passed and current steps. String. Default `\'var(--bs-primary, #3a86ff)\'`\\n\\t- `secondary`: Secondary color of future steps. String. Default `\'var(--bs-secondary, #bbbbc0)\'`\\n\\t- `light`: Primary color of text color in passed anc current steps. String. Default `\'var(--bs-light, white)\'`\\n\\t- `dark`: Secondary color of text color in future steps. String. Default `\'var(--bs-dark, black)\'`\\n\\t- `borderRadius`: Border radius of the step buttons. String. Default `\'50%\'` (circle)\\n\\t- `fontFamily`: Font family of the component. String. Default `\\"\'Helvetica Neue\', Helvetica, Arial, sans-serif\\"`\\n\\n\\t@events\\n\\n\\t- `on:click(e)`: click event with arg as the clicked step index as `e.detail.current` and last step index as `e.detail.last`\\n-->\\n<script>\\n  // A bootstrap step component\\n  import { createEventDispatcher } from \'svelte\'\\n  import Check from \'./Check.svelte\'\\n\\n  export let steps\\n  export let current = 0\\n  export let size = \'3rem\'\\n  export let lineHeight = \'0.3rem\'\\n  export let primary = \'var(--bs-primary, #3a86ff)\'\\n  export let secondary = \'var(--bs-secondary, #bbbbc0)\'\\n  export let light = \'var(--bs-light, white)\'\\n  export let dark = \'var(--bs-dark, black)\'\\n  export let borderRadius = \'50%\'\\n  export let fontFamily = \'\'\\n\\n  if (current > steps.length - 1) {\\n    current = steps.length - 1\\n  }\\n  if (current < 0) {\\n    current = 0\\n  }\\n  $: total = steps.length\\n  $: half = 100 / steps.length / 2\\n  const dispatch = createEventDispatcher()\\n  let onClick = (i) => {\\n    let last = current\\n    current = i\\n    dispatch(\'click\', { current, last })\\n  }\\n<\/script>\\n\\n<div\\n  class=\\"steps-container\\"\\n  style={`--size: ${size}; \\n\\t\\t\\t--primary: ${primary}; \\n\\t\\t\\t--secondary: ${secondary};\\n\\t\\t\\t--light: ${light};\\n\\t\\t\\t--dark: ${dark};\\n\\t\\t\\t--border-radius: ${borderRadius};\\n\\t\\t\\t--font-family: ${\\n        fontFamily || \\"\'Helvetica Neue\', Helvetica, Arial, sans-serif\\"\\n      };`}\\n>\\n  <div class=\\"block\\">\\n    <div class=\\"background\\">\\n      <div class=\\"d-flex align-items-center\\" style=\\"width: 100%; height: 100%\\">\\n        <div style=\\"width: {half}%; height: 100%;\\" />\\n        <div\\n          class=\\"bg-secondary\\"\\n          style=\\"height: {lineHeight}; width: {100 - half * 2}%;\\"\\n        >\\n          <div\\n            class=\\"bg-primary\\"\\n            style=\\"height: 100%; width: {(current * 100) / (total - 1)}%\\"\\n          />\\n        </div>\\n        <div style=\\"width: {half}%; height: 100%\\" />\\n      </div>\\n    </div>\\n\\n    <div class=\\"foreground\\">\\n      <div class=\\"d-flex justify-content-space-around\\">\\n        {#each steps as step, i}\\n          <div\\n            class=\\"step \\n\\t\\t\\t\\t\\t\\t  {i <= current ? `bg-primary text-light` : `bg-secondary text-light`}\\n\\t\\t\\t\\t\\t\\t  \\"\\n            class:shadow={i == current}\\n            on:click={() => {\\n              onClick(i)\\n            }}\\n          >\\n            {#if step.icon}\\n              {#if i < current}\\n                <Check />\\n              {:else if step.iconProps}\\n                <svelte:component this={step.icon} {...step.iconProps} />\\n              {:else}\\n                <svelte:component this={step.icon} />\\n              {/if}\\n            {:else if i < current}\\n              <Check />\\n            {:else}\\n              <span class=\\"steps__number\\">{i + 1}</span>\\n            {/if}\\n          </div>\\n        {/each}\\n      </div>\\n    </div>\\n  </div>\\n\\n  <div class=\\"d-flex align-items-start\\">\\n    {#each steps as step, i}\\n      {#if typeof step.text != \'undefined\'}\\n        <div\\n          class=\\"d-flex justify-content-center\\"\\n          style=\\"width: {100 / total}%;\\"\\n        >\\n          <div class:text-primary={i <= current} class=\\"steps__label\\">\\n            {step.text}\\n          </div>\\n        </div>\\n      {/if}\\n    {/each}\\n  </div>\\n</div>\\n\\n<style>\\n  .steps-container {\\n    font-family: var(--font-family);\\n  }\\n  .block {\\n    display: flex;\\n    flex-flow: row nowrap;\\n  }\\n  .block .background,\\n  .block .foreground {\\n    box-sizing: border-box;\\n    width: 100%;\\n    flex: none;\\n  }\\n\\n  .block .foreground {\\n    margin-left: -100%;\\n  }\\n  .step {\\n    border-radius: var(--border-radius);\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n    width: var(--size);\\n    height: var(--size);\\n    font-size: calc(var(--size) * 0.5);\\n  }\\n  .step:hover {\\n    cursor: pointer;\\n    filter: brightness(85%);\\n  }\\n\\n  .d-flex {\\n    display: flex;\\n  }\\n  .d-flex.align-items-start {\\n    align-items: flex-start;\\n  }\\n  .d-flex.align-items-center {\\n    align-items: center;\\n  }\\n  .d-flex.justify-content-center {\\n    justify-content: center;\\n  }\\n  .d-flex.justify-content-space-around {\\n    justify-content: space-around;\\n  }\\n\\n  .text-primary {\\n    color: var(--primary) !important;\\n  }\\n  .text-light {\\n    color: var(--light) !important;\\n  }\\n  .text-dark {\\n    color: var(--dark) !important;\\n  }\\n  .bg-secondary {\\n    background-color: var(--secondary) !important;\\n  }\\n  .bg-primary {\\n    background-color: var(--primary) !important;\\n  }\\n  .shadow {\\n    box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15) !important;\\n  }\\n</style>\\n"],"names":[],"mappings":"AA2IE,gBAAgB,4BAAC,CAAC,AAChB,WAAW,CAAE,IAAI,aAAa,CAAC,AACjC,CAAC,AACD,MAAM,4BAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,GAAG,CAAC,MAAM,AACvB,CAAC,AACD,oBAAM,CAAC,yBAAW,CAClB,oBAAM,CAAC,WAAW,cAAC,CAAC,AAClB,UAAU,CAAE,UAAU,CACtB,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,IAAI,AACZ,CAAC,AAED,oBAAM,CAAC,WAAW,cAAC,CAAC,AAClB,WAAW,CAAE,KAAK,AACpB,CAAC,AACD,KAAK,4BAAC,CAAC,AACL,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,KAAK,CAAE,IAAI,MAAM,CAAC,CAClB,MAAM,CAAE,IAAI,MAAM,CAAC,CACnB,SAAS,CAAE,KAAK,IAAI,MAAM,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACpC,CAAC,AACD,iCAAK,MAAM,AAAC,CAAC,AACX,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,WAAW,GAAG,CAAC,AACzB,CAAC,AAED,OAAO,4BAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACf,CAAC,AACD,OAAO,kBAAkB,4BAAC,CAAC,AACzB,WAAW,CAAE,UAAU,AACzB,CAAC,AACD,OAAO,mBAAmB,4BAAC,CAAC,AAC1B,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,OAAO,uBAAuB,4BAAC,CAAC,AAC9B,eAAe,CAAE,MAAM,AACzB,CAAC,AACD,OAAO,6BAA6B,4BAAC,CAAC,AACpC,eAAe,CAAE,YAAY,AAC/B,CAAC,AAED,aAAa,4BAAC,CAAC,AACb,KAAK,CAAE,IAAI,SAAS,CAAC,CAAC,UAAU,AAClC,CAAC,AACD,WAAW,4BAAC,CAAC,AACX,KAAK,CAAE,IAAI,OAAO,CAAC,CAAC,UAAU,AAChC,CAAC,AACD,UAAU,4BAAC,CAAC,AACV,KAAK,CAAE,IAAI,MAAM,CAAC,CAAC,UAAU,AAC/B,CAAC,AACD,aAAa,4BAAC,CAAC,AACb,gBAAgB,CAAE,IAAI,WAAW,CAAC,CAAC,UAAU,AAC/C,CAAC,AACD,WAAW,4BAAC,CAAC,AACX,gBAAgB,CAAE,IAAI,SAAS,CAAC,CAAC,UAAU,AAC7C,CAAC,AACD,OAAO,4BAAC,CAAC,AACP,UAAU,CAAE,CAAC,CAAC,MAAM,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,UAAU,AAC1D,CAAC"}'
};
...
<div class="${"steps-container svelte-jq8oz2"}"${add_attribute("style", `--size: ${size}; 
			--primary: ${primary}; 
			--secondary: ${secondary};
			--light: ${light};
			--dark: ${dark};
			--border-radius: ${borderRadius};
			--font-family: ${fontFamily || "'Helvetica Neue', Helvetica, Arial, sans-serif"};`, 0)}><div class="${"block svelte-jq8oz2"}"><div class="${"background svelte-jq8oz2"}"><div class="${"d-flex align-items-center svelte-jq8oz2"}" style="${"width: 100%; height: 100%"}"><div style="${"width: " + escape(half) + "%; height: 100%;"}"></div>
        <div class="${"bg-secondary svelte-jq8oz2"}" style="${"height: " + escape(lineHeight) + "; width: " + escape(100 - half * 2) + "%;"}"><div class="${"bg-primary svelte-jq8oz2"}" style="${"height: 100%; width: " + escape(current2 * 100 / (total - 1)) + "%"}"></div></div>
        <div style="${"width: " + escape(half) + "%; height: 100%"}"></div></div></div>

    <div class="${"foreground svelte-jq8oz2"}"><div class="${"d-flex justify-content-space-around svelte-jq8oz2"}">${each(steps, (step, i) => `<div class="${[
    "step " + escape(i <= current2 ? `bg-primary text-light` : `bg-secondary text-light`) + " svelte-jq8oz2",
    i == current2 ? "shadow" : ""
  ...
  <div class="${"d-flex align-items-start svelte-jq8oz2"}">${each(steps, (step, i) => `${typeof step.text != "undefined" ? `<div class="${"d-flex justify-content-center svelte-jq8oz2"}" style="${"width: " + escape(100 / total) + "%;"}"><div class="${["steps__label svelte-jq8oz2", i <= current2 ? "text-primary" : ""].join(" ").trim()}">${escape(step.text)}</div>
        </div>` : ``}`)}</div>
</div>`;
});
var pathsByName = {
...
<Steps {steps} />`,
      steps: [{ text: "step one" }, { text: "step two" }, { text: "the last step" }],
      props: {}
    },
    {
      title: "With Icons",
...
<div class="${"container"}"><nav class="${"d-flex align-items-center justify-content-between mt-5"}"><h1 class="${"display-4"}">Svelte Steps</h1>
  ...
  ${each(demos, (demo) => `<div class="${"my-4"}"><h3>${escape(demo.title)}</h3>
    ...
    style: "padding: 1rem; border-radius: 0.5rem;"
      ...
      ${validate_component(Steps, "Steps").$$render($$result, Object.assign({ steps: demo.steps }, { current }, demo.props), {}, {})}
    </div>`)}
</div>`;
});
