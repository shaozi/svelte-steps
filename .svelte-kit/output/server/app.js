...
<div class="${"steps-container svelte-14bnmi3"}"${add_attribute("style", `--size: ${size}; 
        ...
        <div class="${"bg-secondary svelte-14bnmi3"}" style="${"height: " + escape(lineHeight) + "; width: " + escape(100 - half * 2) + "%;"}"><div class="${"bg-primary svelte-14bnmi3"}" style="${"height: 100%; width: " + escape(current2 * 100 / (total - 1)) + "%"}"></div></div>
  ...
  <div class="${"d-flex align-items-start svelte-14bnmi3"}">${each(steps, (step, i) => `${typeof step.text != "undefined" ? `<div class="${"d-flex justify-content-center svelte-14bnmi3"}" style="${"width: " + escape(100 / total) + "%;"}"><div class="${[
